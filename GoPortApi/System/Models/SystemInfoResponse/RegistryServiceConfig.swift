...
public struct RegistryServiceConfig: Codable, Hashable {
    ...
    public var allowNondistributableArtifactsCIDRs: [String]? = nil
    ...
    public var allowNondistributableArtifactsHostnames: [String]? = nil
    ...
    public var insecureRegistryCIDRs: [String]? = nil
    public var indexConfigs: [String: IndexInfo]? = nil
