...
extension Server {
     ...
     */
    public func containers(all: Bool = false, limit: Int? = nil, size: Bool = false, filters: String? = nil) async throws -> [GoPortContext:[ContainerSummaryResponseItem]] {
     ...
     */
    public func containerPrune(filters: String? = nil) async throws -> [GoPortContext:ContainerPruneResponseItem] {
