...
extension Server {
     ...
     */
    public func networks(filters: String? = nil) async throws -> [GoPortContext:[NetworkResponse]] {
     ...
     */
    public func pruneNetworks(filters: String? = nil) async throws -> [GoPortContext:NetworkPruneResponseItem] {
