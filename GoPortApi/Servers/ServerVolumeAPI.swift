...
extension Server {
     ...
     */
    public func volumes(filters: String? = nil) async throws -> [GoPortContext:VolumeListResponseItem] {
     ...
     */
    public func pruneVolumes(filters: String? = nil) async throws -> [GoPortContext:VolumePruneResponseItem] {
