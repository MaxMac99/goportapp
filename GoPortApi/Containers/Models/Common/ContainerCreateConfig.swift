...
/** The configuration for creating a container */
public struct ContainerCreateConfig: Codable, Hashable {
...
#if DEBUG
extension ContainerCreateConfig: Previewable {
    public static var preview: ContainerCreateConfig {
        ContainerCreateConfig(image: "hello-world")
    }
}
#endif
